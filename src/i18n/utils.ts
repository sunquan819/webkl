...
export const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    blog: 'All Posts',
    novel: 'Novels',
    novelCategory: 'Novel Series',
    openSource: 'Open Source',
    openSourceCategory: 'Open Source World',
    news: 'Daily News',
    about: 'About',
  ...
  de: {
    ...
    blog: 'Alle Beiträge',
    novel: 'Romane',
    novelCategory: 'Roman Serie',
    openSource: 'Open Source',
    openSourceCategory: 'Open Source Welt',
