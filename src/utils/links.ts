...
// Astro handles base path automatically - use plain paths
...
export function getNewsUrl(date: string, lang: Lang): string {
  if (lang === defaultLang) {
    return `/news/${date}/`;
  }
  return `/${lang}/news/${date}/`;
}

export function getNewsListUrl(lang: Lang): string {
  if (lang === defaultLang) {
    return '/news/';
  }
  return `/${lang}/news/`;
...
export function getAboutUrl(lang: Lang): string {
  if (lang === defaultLang) {
    return '/about/';
  }
  return `/${lang}/about/`;
